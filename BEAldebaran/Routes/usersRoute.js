...
router.route("/admin").post(userController.admin)

router.route("/approveUser").post(userController.approveUser)

router.route("/usersNotApproved").get(userController.usersNotApproved)
